...
namespace ExpressProfiler
{
    public partial class MainForm : Form
    {
        ...
        internal const string versionString = "事件探查器特别版 v2.1";
        ...
        public MainForm(IDocumentObject obj)
        {
            InitializeComponent();
            _Obj = obj;
        ...
        private void MainForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                if (MessageBox.Show("跟踪仍然在运行. 你确定要关闭该应用吗?","事件探查器",MessageBoxButtons.YesNo,MessageBoxIcon.Question
		...
		private void mnAbout_Click(object sender, EventArgs e)
		{
            ...
            aboutMsg.AppendLine("\n本工具来自网上开源代码，并由蓬蒿汉化插件化: 1005928472@qq.com");
