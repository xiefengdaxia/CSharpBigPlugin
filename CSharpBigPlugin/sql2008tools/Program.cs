...
namespace sql2008tools
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "SqlServer2008R2企业版绿化";
            Console.WriteLine("=========================================================================");

            Console.WriteLine("正在初始化...");

            string path = @System.Environment.CurrentDirectory.Replace("\\", "\\\\");
...
[-HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Microsoft SQL Server\MSSQL10_50.XSQL2008]");
            ...
            Console.WriteLine("初始化完毕！请选择：");
            string userCommand = "";
            while (userCommand != "q")
            {
                Console.WriteLine("=========================================================================");
                Console.WriteLine("|请输入您的指令，按回车键↓↓");
                Console.WriteLine("|命令1 安装SqlServer2008R2↓↓");
                Console.WriteLine("|命令2 卸载SqlServer2008R2↓↓");
                Console.WriteLine("|命令3 启动SqlServer2008R2↓↓");
                Console.WriteLine("|命令4 停止SqlServer2008R2↓↓");
                Console.WriteLine("|ps:实例名为.\\xsql2008 sa默认密码为1");
                Console.WriteLine("|命令q 退出↓↓");
                Console.WriteLine("=========================================================================");
        ...
        private static void RunCmdCode(string code)
        {
            string str = code;
